public class MazeGame {
    public static void main(String[] args) {
        if (args.length != 1) {
            System.out.println("usage: java MazeGame box|line");
            System.exit(0);
        }

        MazeFactory mg = new MazeFactory(args[0]);
...
class MazeFactory {
	...
	public MazeFactory(String mazeType) {
		if (mazeType.equals("box")) {
			this.mazeGen = new BoxGenerator();
		} else if (mazeType.equals("line")) {
